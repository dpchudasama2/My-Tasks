...
//			"USE "+schemaName,
			...
			+ " PARENTPROJECTID INT REFERENCES PROJECT(PROJECTID) ON DELETE CASCADE,"
			...
			+ " COMPONENTTYPEID INT DEFAULT 1 REFERENCES COMPONENTTYPE(COMPONENTTYPEID) ON DELETE CASCADE,"
